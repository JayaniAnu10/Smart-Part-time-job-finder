        ...
        <div className="space-y-4">
          ...
          {loading && (
            <div className="flex flex-col items-center justify-center py-20 text-slate-400">
              ...
              <p className="font-medium animate-pulse">Syncing your notifications...</p>
            </div>
          )}
          ...
          {error && (
            <div className="bg-red-50 border border-red-100 p-6 rounded-2xl text-center">
              ...
              <button onClick={() => refetch()} className="mt-3 text-red-700 underline text-sm">Try again</button>
            </div>
          )}
          ...
          {!loading && !error && notifications.length === 0 && (
            <div className="bg-white border border-dashed border-slate-300 p-12 rounded-3xl text-center">
              ...
              <h3 className="text-slate-900 font-bold text-xl">All caught up!</h3>
