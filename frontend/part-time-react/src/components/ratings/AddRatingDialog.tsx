  ...
  return (
    <div className="fixed inset-0 bg-background flex items-center justify-center z-50">
      <div className="bg-card p-6 rounded-lg w-full max-w-md space-y-4">
        <h2 className="text-lg text-secondary dark:text-primary font-semibold">
          Add Rating
        </h2>

        <div>
          <label className="text-sm text-secondary/80 dark:text-primary/80">
            Rating
          </label>
        ...
        <div>
          <label className="text-sm text-secondary/70 dark:text-primary/70">
            Comment
          </label>
          <textarea
            value={comment}
        ...
        <div className="flex justify-end gap-3">
          <button
            onClick={onClose}
            className="px-4 py-1 rounded-[6px] border border-secondary bg-primary-foreground/60 dark:border-white/30 
