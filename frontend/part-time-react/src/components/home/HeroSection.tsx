...
const HeroSection = () => {
  ...
  const stats: StatItem[] = [
    ...
    {
      icon: Users,
      value: statsData?.totalJobSeekers
        ? `${statsData.totalJobSeekers.toLocaleString()}+`
        : "0",
      label: "Job Seekers",
    },
    {
      icon: Building2,
      value: statsData?.totalEmployers
        ? `${statsData.totalEmployers.toLocaleString()}+`
        : "0",
      label: "Companies",
    },
  ];
  ...
  return (
    <motion.section
      ...
      animate="visible"
      variants={fadeIn}
      className="bg-linear-to-br from-background via-yellow-300/40 dark:via-blue-300/20 to-background py-16"
    >
